...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->TOF0.,IN,,__GET_VAR(data__->I1,));
  __SET_VAR(data__->TOF0.,PT,,__time_to_timespec(1, 0, 10, 0, 0, 0));
  TOF_body__(&data__->TOF0);
  __SET_VAR(data__->,Q1,,!(__GET_VAR(data__->TOF0.Q,)));
  __SET_VAR(data__->,ET,,__GET_VAR(data__->TOF0.ET,));
  __SET_VAR(data__->TON0.,IN,,!(__GET_VAR(data__->Q1,)));
  __SET_VAR(data__->TON0.,PT,,__time_to_timespec(1, 0, 10, 0, 0, 0));
  TON_body__(&data__->TON0);
  __SET_VAR(data__->,Q2,,__GET_VAR(data__->TON0.Q,));
  __SET_VAR(data__->,ET,,__GET_VAR(data__->TON0.ET,));
