...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->COUNT0,0,retain)
  __INIT_VAR(data__->OUT,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->OUT0,__BOOL_LITERAL(FALSE),retain)
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->R_TRIG1.,CLK,,__GET_VAR(data__->I1,));
  ...
  __SET_VAR(data__->,OUT,,__GET_VAR(data__->CTU0.Q,));
  __SET_VAR(data__->,COUNT,,__GET_VAR(data__->CTU0.CV,));
  __SET_VAR(data__->R_TRIG2.,CLK,,__GET_VAR(data__->I2,));
  R_TRIG_body__(&data__->R_TRIG2);
  __SET_VAR(data__->CTD0.,CD,,__GET_VAR(data__->R_TRIG2.Q,));
  __SET_VAR(data__->CTD0.,LD,,__GET_VAR(data__->RESET0,));
  __SET_VAR(data__->CTD0.,PV,,10);
  CTD_body__(&data__->CTD0);
  __SET_VAR(data__->,OUT0,,__GET_VAR(data__->CTD0.Q,));
  __SET_VAR(data__->,COUNT0,,__GET_VAR(data__->CTD0.CV,));
